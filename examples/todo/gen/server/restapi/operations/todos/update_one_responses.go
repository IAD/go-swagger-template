...
// NewUpdateOneDefaultFunc is declaration for func that create response
type NewUpdateOneDefaultFunc func() *UpdateOneDefault
...
// WithErr adds the Error payload with a default code to the update one default response
func (o *UpdateOneDefault) WithErr(err error) *UpdateOneDefault {
...
// WithError  adds the Error payload to the update one default response
func (o *UpdateOneDefault) WithError(code string, message string) *UpdateOneDefault {
	o.Payload = &models.Error{
		Code:    code,
		Message: message,
	}
