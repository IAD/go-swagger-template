...
func NewTodoAPI(spec *loads.Document) *TodoAPI {
	return &TodoAPI{
		...
		TodosAddOneHandler: todos.AddOneHandlerFunc(func(params *todos.AddOneParams, principal interface{}, addOneCreated todos.NewAddOneCreatedFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosAddOne has not yet been implemented")
		}),
		TodosDestroyOneHandler: todos.DestroyOneHandlerFunc(func(params *todos.DestroyOneParams, principal interface{}, destroyOneNoContent todos.NewDestroyOneNoContentFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosDestroyOne has not yet been implemented")
		}),
		TodosFindHandler: todos.FindHandlerFunc(func(params *todos.FindParams, principal interface{}, findOK todos.NewFindOKFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosFind has not yet been implemented")
		}),
		TodosUpdateOneHandler: todos.UpdateOneHandlerFunc(func(params *todos.UpdateOneParams, principal interface{}, updateOneOK todos.NewUpdateOneOKFunc) middleware.Responder {
