...
import (
	...
	"github.com/IAD/go-swagger-template/examples/todo/gen/server/restapi/operations"
	"github.com/IAD/go-swagger-template/examples/todo/gen/server/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../server --name Todo --spec ../../../swagger.yml --template-dir /home/igor/dev/go-swagger-template/templates --exclude-main
...
func configureAPI(api *operations.TodoAPI) http.Handler {
	...
	// Handler for POST /
	api.TodosAddOneHandler = todos.AddOneHandlerFunc(func(params *todos.AddOneParams, principal interface{},
	...
	api.TodosDestroyOneHandler = todos.DestroyOneHandlerFunc(func(params *todos.DestroyOneParams, principal interface{},
	...
	// Handler for GET /
	api.TodosFindHandler = todos.FindHandlerFunc(func(params *todos.FindParams, principal interface{},
		findOK todos.NewFindOKFunc,
	) middleware.Responder {
		return middleware.NotImplemented("operation todos.Find has not yet been implemented")
	})
	// Handler for PUT /{id}
	api.TodosUpdateOneHandler = todos.UpdateOneHandlerFunc(func(params *todos.UpdateOneParams, principal interface{},
