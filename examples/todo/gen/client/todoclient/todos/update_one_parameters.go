...
import (
	...
	todoclientmodels "github.com/IAD/go-swagger-template/examples/todo/gen/client/todoclientmodels"
)
...
func (o *UpdateOneParams) WithBody(body *todoclientmodels.Item) *UpdateOneParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update one params
func (o *UpdateOneParams) SetBody(body *todoclientmodels.Item) {
	o.Body = body
}
